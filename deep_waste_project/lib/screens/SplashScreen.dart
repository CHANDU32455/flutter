...
class _SplashScreenState extends State<SplashScreen>
  ...
  late User user;  // Make user late or nullable
  bool isLoading = false;

  Future getUserInfo() async {
    setState(() => isLoading = true);
    user = await DatabaseManager.instance.getUser() ?? User(id: 0, name: ""); // Initialize user or handle null
  ...
  void navigationPage() {
    Navigator.of(context).pushReplacement(MaterialPageRoute(
        builder: (_) =>
            !isLoading ? HomeScreen(title: '',) : OnboardingScreen()));
  }
